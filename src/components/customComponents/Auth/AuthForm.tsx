...
import { signIn as logIn } from '../../../lib/features/auth/authSlice'
    ...
    return (
        <Dialog>
            ...
            <DialogContent className='z-[60] '>
                <ScrollArea className='max-h-screen z-10'>
                    <DialogHeader className='gap-4 tw-fc'>
                        ...
                        <Button onClick={() => handleLogin('google')} className='gap-2 tw-md-b flex' variant={'outline'}>
                        ...
                        <Button onClick={() => handleLogin('github')} className='gap-2 tw-md-b flex' variant={'outline'}>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
